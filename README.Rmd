...
do.
- Shiny uses a reactive model to define the app-logic, Fiery doesn't care about what you
do (see a pattern emerge).
- Shiny wants you to use [htmltools](https://github.com/rstudio/htmltools) to 
build the html, Fiery really doesn't care about what you use.
...
both Shiny and Fiery, but where Shiny builds an elaborate, opinionated and 
