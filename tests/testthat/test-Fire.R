...
test_that('id converter can be set and gets called', {
  ...
  expect_equal(
    app$get_data('id'),
    session_id_cookie()(reqres::Request$new(request))
  )
...
test_that('life cycle events get fired', {
  ...
  expect_equal(
    igniteRes,
    c('start', 'cycle-start', 'cycle-end', 'cycle-start', 'cycle-end', 'end')
  )
  ...
  app$remove_data('events')
  expect_equal(
    unique(igniteResNoBlock),
    c('start', 'cycle-start', 'cycle-end', 'end')
  )
  ...
  expect_equal(
    reigniteResNoBlock,
    c('start', 'resume', 'cycle-start', 'cycle-end', 'end')
  )
})
...
test_that('message events fire', {
  ...
  app$on('message', function(server, message, arg_list, ...) {
    ...
    server$set_data(
      'passed_args',
      list(test = arg_list$test, message = message)
    )
  })
